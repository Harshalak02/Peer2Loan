...
export const paymentService = {
  ...
  autoVerify: (data) => api.post("/payments/auto-verify", data),
};

export const phonepeService = {
  createPayment: (data) => api.post("/phonepe/create-payment", data),
...
export const joinRequestService = {
  getGroupInfo: (accessCode) =>
    api.get(`/join-requests/group-info/${accessCode}`),
  requestJoin: (requestData) =>
    api.post("/join-requests/request-join", requestData),
  getPendingRequests: (groupId) =>
    api.get(`/join-requests/pending-requests/${groupId}`),
